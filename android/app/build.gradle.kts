...
android {
    namespace = "com.allinconnect.app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.allinconnect.app"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        // BuildConfig fields
        buildConfigField("String", "API_BASE_URL", "\"${project.findProperty("API_BASE_URL") ?: "https://allinconnect-back-1.onrender.com/api/v1"}\"")
    }
